...
from mcp.types import InitializeResult  # Add this import for the correct type
...
class Server:
    ...
    def __init__(self, name: str, config: Dict[str, Any]) -> None:
        ...
        self.capabilities: Optional[InitializeResult] = None  # Update type annotation here

    async def initialize(self) -> None:
        """Initialize the server connection."""
        server_params = StdioServerParameters(
            command=shutil.which("npx") or "npx" if self.config['command'] == "npx" else self.config['command'],
